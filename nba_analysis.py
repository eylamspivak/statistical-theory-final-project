...
def cross_validation(data):
    ...
    # FIX: scale INSIDE a Pipeline so each fold's scaler is fit only on
    # that fold's training data, not on the full dataset beforehand.
    # (For plain OLS this doesn't change R at all -- linear regression
    # is invariant to per-column affine rescaling -- but the Pipeline
    # removes any doubt and is the correct general pattern.)
